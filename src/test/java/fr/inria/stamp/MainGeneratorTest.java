...
public class MainGeneratorTest extends AbstractTest {
    ...
    public void test() throws Exception {
        ...
        final String expectedMainMethod = "public static void main(String[] args) {" + AmplificationHelper.LINE_SEPARATOR+
                ...
                "    int lit3 = catg.CATG.readInt(100);" + AmplificationHelper.LINE_SEPARATOR+
                "    String lit4 = catg.CATG.readString(\"Potion\");" + AmplificationHelper.LINE_SEPARATOR+
                "    int lit5 = catg.CATG.readInt(5);" + AmplificationHelper.LINE_SEPARATOR+
                "    String lit6 = catg.CATG.readString(\"Timoleon\");" + AmplificationHelper.LINE_SEPARATOR+
                "    int lit7 = catg.CATG.readInt(1000);" + AmplificationHelper.LINE_SEPARATOR+
                "    String lit8 = catg.CATG.readString(\"Potion\");" + AmplificationHelper.LINE_SEPARATOR+
                ...
                "    Seller seller = new Seller(lit3, Collections.singletonList(new Item(lit4, lit5)));" + AmplificationHelper.LINE_SEPARATOR+
                "    Player player = new Player(lit6, lit7);" + AmplificationHelper.LINE_SEPARATOR+
                "    player.toString();" + AmplificationHelper.LINE_SEPARATOR+
                "    seller.toString();" + AmplificationHelper.LINE_SEPARATOR+
                "    player.buyItem(lit8, seller);" + AmplificationHelper.LINE_SEPARATOR+
                "    player.toString();" + AmplificationHelper.LINE_SEPARATOR+
                "    seller.toString();" + AmplificationHelper.LINE_SEPARATOR+
                "    try {" + AmplificationHelper.LINE_SEPARATOR+
