 ...
 * on 10/11/17
 */
public class GenerationAlloyModelTest extends AbstractTest {
    ...
    public void test() {
        try {
            ...
            final TestListener listener = TestLauncher.runFromSpoonNodes(configuration,
                    "src/test/resources/calculator/target/classes/"
                            + AmplificationHelper.PATH_SEPARATOR + dependencies,
                    testClass, tests
            );
            assertTrue(listener.getFailingTests().isEmpty());
