...
/**
 * This is a overrided version of the Configuration Class of DSpot
 */
public class Configuration {
    ...
    public final boolean JBSEmode;

    public Configuration(String pathToConfigurationFile, List<Amplifier> amplifiers, int nbIteration, List<String> testClasses, String pathToOutput, TestSelector selector, List<String> namesOfTestCases, long seed, int timeOutInMs, String automaticBuilderName, String mavenHome, Integer maxTestAmplified, boolean clean, boolean jbsEmode) {
