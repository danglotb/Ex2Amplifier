...
import fr.inria.diversify.dspot.amplifier.BooleanLiteralAmplifier;
import fr.inria.diversify.dspot.amplifier.CharLiteralAmplifier;
...
public class JSAPOptions {
    ...
    private static JSAP initJSAP() {
        ...
        JBSEmode.setShortFlag('z');
        JBSEmode.setLongFlag("jbse");
        JBSEmode.setDefault("false");
        JBSEmode.setHelp("Enable Ex2Amplifier in JBSE mode");
